<div class="flex flex-col items-center justify-center py-16 px-4">
    ...
    <a href="{{ route('cultivos.create') }}" class="px-6 py-3 bg-naranja-oscuro text-white rounded-lg hover:bg-[#E07F00] transition font-semibold shadow-md flex items-center gap-2">
