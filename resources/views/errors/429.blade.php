    ...
    <div class="w-full max-w-lg p-0 bg-white rounded-lg shadow-lg overflow-hidden sap-card">
        <div class="p-6 bg-gradient-to-r from-purple-600 to-purple-700 text-white">
            <div class="flex items-center justify-center">
                <i class="material-icons mr-3" style="font-size:28px;">timer</i>
                <h2 class="text-2xl font-bold">Error 429</h2>
            </div>
        </div>

        <div class="p-8 flex flex-col items-center justify-center text-center">
            <div class="text-9xl font-bold text-purple-200 mb-4">429</div>
            <h3 class="text-xl font-semibold text-gray-700 mb-2">Demasiadas solicitudes</h3>
            <p class="text-gray-600 mb-8">Lo sentimos, has realizado demasiadas solicitudes. Por favor, espera un momento e intenta nuevamente.</p>
