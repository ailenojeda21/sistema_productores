...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 p-4">
    <div class="w-full max-w-lg p-0 bg-white rounded-lg shadow-lg overflow-hidden sap-card">
        <div class="p-6 bg-gradient-to-r from-yellow-600 to-yellow-700 text-white">
            <div class="flex items-center justify-center">
                <i class="material-icons mr-3" style="font-size:28px;">no_encryption</i>
                <h2 class="text-2xl font-bold">Error 403</h2>
            </div>
        </div>

        <div class="p-8 flex flex-col items-center justify-center text-center">
            <div class="text-9xl font-bold text-yellow-200 mb-4">403</div>
            <h3 class="text-xl font-semibold text-gray-700 mb-2">Acceso prohibido</h3>
            <p class="text-gray-600 mb-8">Lo sentimos, no tienes permisos para acceder a esta página.</p>
