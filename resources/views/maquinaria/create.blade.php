            ...
            <form method="POST" action="{{ route('maquinaria.store') }}">
                ...
                @if(session('info'))
                    <div class="mb-4 bg-blue-50 p-3 rounded text-blue-700">
                        ...
                        @if($existing)
                            <div class="mt-2">
                                <a href="{{ route('maquinaria.edit', $existing->id) }}"
                                   class="underline text-azul-marino">Ir a editar</a>
                            </div>
                        @endif
                    </div>
                @endif
                ...
                <div class="mb-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="tractor" id="tractor"
                               class="mr-2 custom-checkbox" {{ old('tractor') ? 'checked' : '' }}>
                        Tractor
                    </label>
                </div>
