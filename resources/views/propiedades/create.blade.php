        ...
        <form method="POST" action="{{ route('propiedades.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex items-center mt-6">
                    <input type="checkbox" name="es_propietario" id="es_propietario" class="mr-2">
                    <label for="es_propietario">¿Es propietario?</label>
                </div>
                <div class="flex items-center mt-6">
                    <input type="checkbox" name="derecho_riego" id="derecho_riego" class="mr-2">
                ...
                <div id="rut-fields" class="hidden md:col-span-2">
                    <div class="mt-2">
                        ...
                        <input id="rut_valor" name="rut_valor" type="number" step="0.01" class="w-full p-2 border border-gray-300 rounded">
                    </div>
                    <div class="mt-2">
                ...
                <div class="flex items-center mt-6">
                    <input type="checkbox" name="cierre_perimetral" id="cierre_perimetral" class="mr-2">
