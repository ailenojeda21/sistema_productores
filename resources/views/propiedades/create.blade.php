                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex items-center mt-6">
                        <input type="checkbox" name="es_propietario" id="es_propietario"
                               class="mr-2 rounded-full custom-checkbox">
                        <label for="es_propietario">¿Es propietario?</label>
                    </div>
                    <div class="flex items-center mt-6">
                        <input type="checkbox" name="derecho_riego" id="derecho_riego"
                               class="mr-2 rounded-full custom-checkbox"
                               onchange="document.getElementById('tipoDerechoRiegoDiv').style.display = this.checked ? 'block' : 'none';">
                    ...
                    <div id="tipoDerechoRiegoDiv" style="display:none;" class="mt-2 md:col-span-2">
                        <label for="tipo_derecho_riego" class="block text-gray-700 font-semibold mb-1">Tipo de derecho
                            de riego:</label>
                    ...
                    <div id="rut-fields" class="hidden md:col-span-2">
                        ...
                        <div class="mt-2">
                            <label class="block text-gray-700 font-semibold mb-1" for="rut_archivo_file">Adjuntar RUT
                                (PDF, opcional)</label>
                            <input id="rut_archivo_file" name="rut_archivo_file" type="file" accept="application/pdf"
                                   class="w-full p-2 border border-gray-300 rounded">
