...
<div class="w-full max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="mb-4"><strong>Hectáreas:</strong> {{ number_format($propiedad->hectareas, 0, '', '') }}</div>
    ...
    @endif
            ...
            <div class="mb-4"><strong>Hectáreas con malla:</strong> {{ number_format($propiedad->hectareas_malla, 0, '', '') }}</div>
