...
<div class="w-full max-w-5xl mx-auto">
    ...
    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Valor RUT</th>
    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Archivo RUT</th>
    ...
    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Condición de acceso</th>
    ...
    <th class="px-4 py-2"></th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2">{{ $propiedad->rut_valor }}</td>
                    <td class="px-4 py-2">{{ $propiedad->rut_archivo }}</td>
                    <td class="px-4 py-2">{{ $propiedad->malla ? 'Sí' : 'No' }}</td>
                    <td class="px-4 py-2">{{ $propiedad->hectareas_malla }}</td>
                    <td class="px-4 py-2">{{ $propiedad->tecnologia_riego }}</td>
                    <td class="px-4 py-2">{{ $propiedad->condicion_acceso }}</td>
