        ...
        <div class="max-w-md w-full mx-auto">
            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="email" name="email" type="email" value="{{ old('email', $email) }}" required autofocus readonly class="mt-1 block w-full rounded border-gray-300 bg-gray-100 focus:border-naranja-oscuro focus:ring focus:ring-naranja-oscuro/30">
                </div>
