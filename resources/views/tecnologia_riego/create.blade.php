...
<div class="container mx-auto py-8">
    <div class="max-w-lg mx-auto bg-white p-8 rounded shadow">
        <h2 class="text-2xl font-bold text-teal-700 mb-6">Nueva Tecnología de Riego</h2>
        <form method="POST" action="{{ route('tecnologia_riego.store') }}">
            ...
            <button type="submit" class="w-full py-2 px-4 bg-teal-600 hover:bg-teal-700 text-white font-bold rounded">Guardar</button>
        </form>
    </div>
</div>
@endsection
