...
<div class="container mx-auto py-8">
    <div class="sap-card max-w-xl mx-auto overflow-hidden">
        <div class="flex items-center p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <i class="material-icons mr-3" style="font-size:24px;">irrigation</i>
            <h2 class="text-xl font-bold">Nueva Tecnología de Riego</h2>
        </div>

        <div class="p-6">
            <form method="POST" action="{{ route('tecnologia_riego.store') }}">
                @csrf
                ...
                <div class="flex justify-between items-center mt-8">
                    <a href="{{ route('tecnologia_riego.index') }}" class="sap-btn sap-btn-outline flex items-center">
