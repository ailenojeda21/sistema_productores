        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Usuario</th>
                    ...
                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Nombre Feria</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-4 py-2 text-base">{{ $comercio->id }}</td>
                    <td class="px-4 py-2 text-base">{{ $comercio->usuario_id }}</td>
                    <td class="px-4 py-2 text-base">{{ $comercio->infraestructura_empaque ? 'Sí' : 'No' }}</td>
                    <td class="px-4 py-2 text-base">{{ $comercio->comercio_feria ? 'Sí' : 'No' }}</td>
                    <td class="px-4 py-2 text-base">{{ $comercio->vende_en_finca ? 'Sí' : 'No' }}</td>
                    <td class="px-4 py-2 text-base">{{ $comercio->nombre_feria }}</td>
