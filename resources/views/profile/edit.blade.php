            ...
            <form method="POST" action="{{ route('profile.update') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4 md:col-span-2">
                        ...
                        <input id="name" name="name" type="text" class="w-full p-2 border border-gray-300 rounded"
                    ...
                    <div class="mb-4 md:col-span-2">
                        ...
                        <input id="email" name="email" type="email" class="w-full p-2 border border-gray-300 rounded"
                    ...
                    <div class="mb-4 md:col-span-2">
                        ...
                        <input id="dni" name="dni" type="text" class="w-full p-2 border border-gray-300 rounded"
                    ...
                    <div class="mb-4 flex items-center md:col-span-2">
                        <input id="es_propietario" name="es_propietario" type="checkbox" class="mr-2 custom-checkbox"
                               value="1" {{ old('es_propietario', $user->es_propietario) ? 'checked' : '' }}>
