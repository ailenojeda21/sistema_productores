...
<div class="w-full max-w-5xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-stretch md:space-x-4">
        ...
        {{-- Contenedor blanco cuadrado para el avatar, a la par de la tabla --}}
        <div class="w-full md:w-1/3 flex justify-center md:justify-end mt-4 md:mt-0">
            <div class="bg-white rounded-lg shadow-lg p-6 w-72 h-72 flex flex-col items-center justify-center">
                <div class="h-44 w-44 md:h-48 md:w-48 rounded-full overflow-hidden shadow-lg">
                    <img src="{{ $user->avatar ? asset('storage/'.$user->avatar) : asset('images/melon2.png') }}"
                         alt="Avatar"
